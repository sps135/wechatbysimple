...
import com.tencent.mars.wrapper.task.LoginTaskWrapper;
...
public class MarsServiceProxy implements ServiceConnection {
    ...
    public static final String SERVICE_DEFAULT_CLASSNAME = "com.tencent.mars.wrapper.service.MarsServiceNative";
    ...
    private MarsReportConnectInfo connectInfo = new MarsReportConnectInfo.Stub() {
        @Override
        public void reportConnectInfo(int status, int longlinkstatus) throws RemoteException {
            Intent intent = new Intent();
            intent.setAction("LONG_LINK_STATUS");

            Bundle bundle = new Bundle();
            bundle.putInt("longLinkStatus", longlinkstatus);
            intent.putExtras(bundle);

            intent.setComponent(new ComponentName("com.simple.wechatsimple",
                    "com.simple.wechatsimple.util.PushReceiver"));
    ...
    public void setAccountInfo(int userId) {
        try {
            ...
            service.setAccountInfo(userId, "account");
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
    ...
    public void onServiceConnected(ComponentName componentName, IBinder binder) {
        ...
        try {
            ...
            service.registerReportConnectInfo(connectInfo);
    ...
    public void onServiceDisconnected(ComponentName componentName) {
        android.util.Log.i("onServiceDisconnected","onServiceDisconnected");
        try {
